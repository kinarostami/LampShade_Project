...
namespace ServiceHost.Pages
{
    ...
    public class CheckOutModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            Cart = _cartCalculatorService.ComputeCart(cartItem);
        ...
        public IActionResult OnGetCallBack([FromQuery] string authority, [FromQuery] string status, [FromQuery] long oId)
        {
            ...
            {
                result = result.Failed("پرداخت نا موفق بود,در صورت کسر وجه از حساب شما تا 24 ساعت آینده به حساب شما بازگرداننده خواهد شد");
                return RedirectToPage("/PaymentResult", result);
            }
