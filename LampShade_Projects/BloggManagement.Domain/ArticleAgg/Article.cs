...
namespace BlogManagement.Domain.ArticleAgg
{
    public class Article : EntityBase
    {
        ...
        public string CanonicalAddress { get; protected set; }
        ...
        public Article(string title,string shortDescription,string description,string picture,string pictureAlt
            ,string pictureTitle,DateTime publishDate,string slug,string keywords,string metaDescription,string canonicalAddress,long categoryId)
        {
            Title = title;
